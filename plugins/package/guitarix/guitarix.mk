...
GUITARIX_VERSION = b337e6c3b7d54a605922af201804fb71a4b83f1d
...
define GUITARIX_CONFIGURE_CMDS
	(cd $(@D)/trunk; $(GUITARIX_TARGET_WAF) configure --prefix=/usr --disable-sse --no-lv2-gui --no-standalone --includeconvolver --no-faust)
endef
...
define GUITARIX_INSTALL_TARGET_CMDS
	...
	cp -rL $($(PKG)_PKGDIR)/gx_aclipper.lv2/*            $(TARGET_DIR)/usr/lib/lv2/gx_aclipper.lv2/
